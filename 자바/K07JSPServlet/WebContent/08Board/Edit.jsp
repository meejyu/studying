...
String searchField=request.getParameter("searchField");//검색할필드명
...
<table border="1" width="90%">
	...
	<tr>
		<td colspan="2" align="center">
			<button type="submit" onclick="location.href='List.jsp?<%=queryStr %>';">작성완료</button>
